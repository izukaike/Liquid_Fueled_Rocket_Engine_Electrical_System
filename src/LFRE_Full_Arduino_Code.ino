...
class status_register{
  ...
  private:
      ...
      // register  8= a4, 7=v1, 6=v2, 5=i1,4=a1, 3=a2, 2=a3, 1 = start
      char status_buff = 0b00000001; //10001110  // what are getting is 11100111 *sparked* Not sparked 11101111
};
